...
sealed public interface InMemoryColumn extends Column {
    ...
    final class AssociationColumn implements InMemoryColumn, dgroomes.data_system.AssociationColumn, ColumnFilterable.AssociationColumnFilterable {
